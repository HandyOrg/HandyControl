...
public partial class ConfettiCannonDemo : Avalonia.Controls.UserControl
{
    ...
    private void ButtonSnowOnClick(object? sender, RoutedEventArgs e)
    {
        ...
        new AnimationFrame(this).Start(_ =>
        {
            double timeLeft = (animationEnd - DateTime.Now).TotalMilliseconds;
    ...
    private class AnimationFrame
    {
        ...
        public AnimationFrame(Visual host)
        {
            _host = host;
        }
