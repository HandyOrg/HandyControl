...
public class HoneycombPanel : Panel
{
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        var layoutChildren = Children.Where(child => child.IsVisible).ToList();
    ...
    private class HoneycombStuffer
    {
        ...
        public Rect Move()
        {
            ...
            if (_currentIndex > _maxIndex)
            {
                ...
                _currentIndex = 0;
                _childBounds = _childBounds.Translate(new Vector(_offsetX, -_offsetY));
                return _childBounds;
            }
            ...
            if (_turns > 0)
            {
                ...
                _childBounds = _childBounds.Translate(new Vector(_offsetXArr[index], _offsetYArr[index]));
            }
